      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mt-10">
          <a
            ...
            className="inline-flex items-center rounded-full bg-zinc-900 px-8 py-3 text-sm font-semibold text-white shadow-sm transition-opacity hover:opacity-80 dark:bg-zinc-50 dark:text-zinc-900"
          >
